      ...
      <section class="resources">
        <div>
          ...
          <i18n path="home.why.more" tag="p">
            <template #wiki>
              <router-link to="/wiki/Why-AquaPerms">{{ $t('home.why.why') }}</router-link>
            </template>
          </i18n>
        ...
        <div>
          ...
          <a href="https://github.com/XTHESilent/AquaPerms" class="resource">
            <span>
          ...
          <a href="https://discord.gg/xWNVTE7rp8" class="resource">
            <span>
              <font-awesome :icon="['fab', 'discord']" />
              Discord
            </span>
            <small>{{"Join 40 others to discuss the project and ask/answer questions"}}</small>
          </a>
...
main.home {
  ...
  .download {
    ...
    a {
      background: rgba(50, 137, 193, 0.75);
      color: $navy;
      font-size: 1.5em;
      padding: 1rem 2rem;
      text-align: center;
