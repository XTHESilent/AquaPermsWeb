        ...
        <div>
          ...
          <ul class="changelog">
            <li v-for="entry in changeLog" :key="entry.version">
              <span>
                <a
                  :href="`https://discord.gg/tfRdcEKAsq`"
                  target="_blank"
                >
          ...
          <ul>
            ...
            <i18n path="download.trouble.support" tag="li">
              <template #discord>
                <a href="https://discord.gg/FSKERv5qsD" target="_blank">Discord</a>
              </template>
            </i18n>
          </ul>
        </div>
      ...
      <section class="resources">
        <div>
          <a :href="additionalPlugins['extracontexts']" class="resource">
            ...
            <small>AquaPerms 5.0 and above, Bukkit only</small>
          </a>
          <div>
      ...
      <section class="resources">
        <div>
          ...
          <div>
            <p>
              ...
              <code>/papi ecloud download AquaPerms</code>
              or by
        ...
        <div>
          <a :href="placeholderExpansions['fabric-placeholderapi']" class="resource">
            ...
            <small>AquaPerms 5.0 and above, Fabric only</small>
          </a>
          <div>
