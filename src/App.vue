    ...
    <nav id="nav">
      <div>
        <router-link to="/" class="logo">
          <img alt="AquaPerms logo" src="@/assets/logo.svg">
          <span>AquaPerms</span>
        </router-link>
        <transition name="fade">
          <div v-if="!config.selfHosted && !isSponsorRoute" class="nav-message">
            <router-link to="/sponsor">
              <hr />
              <img src="@/assets/aquasplashmc.svg" alt="AquasplashMC">
      ...
      <ul :class="{ active: menu, 'top-level': true }">
        ...
        <template v-if="!config.selfHosted">
          <li class="external overlap">
            <a href="https://github.com/XTHESilent/AquaPerms" target="_blank" class="github">
              <font-awesome :icon="['fab', 'github']" fixed-width />
              <span>GitHub</span>
            </a>
          </li>
          <li class="external">
            <a href="https://discord.gg/FSKERv5qsD" target="_blank" class="discord">
      ...
      <div class="footer">
        <ul>
          <li>
            ...
            <a href="https://github.com/XTHESilent/AquaPermsWeb" target="_blank">AquaPermsWeb</a>
            @
            <a :href="'https://github.com/XTHESilent/AquaPermsWeb/commit/' + commitHash" target="_blank">{{ commitHash }}</a>
          </li>
          <li>
            <router-link v-if="!config.selfHosted" to="/wiki/Credits" target="_blank">
              Copyright © 2017-{{ new Date().getFullYear().toString() }} AquaPerms contributors
            </router-link>
            <a v-else href="https://aquaperms.net/wiki/Credits" target="_blank">
              Copyright © 2017-{{ new Date().getFullYear().toString() }} AquaPerms contributors
            </a>
          </li>
        </ul>
  ...
  metaInfo: {
    ...
    meta: [
      ...
      },
      {
        ...
        content: 'Website & online apps for the AquaPerms plugin.',
      },
      {
        property: 'og:type',
        content: 'product',
      ...
      {
        property: 'og:image',
        content: 'https://aquaperms.net/logo.png',
      },
      {
        property: 'og:url',
        content: 'https://aquaperms.net/',
      },
      {
        property: 'og:site_name',
        content: 'AquaPerms - A permissions plugin for Minecraft servers.',
      },
    ],
  },
...
:root {
  ...
  --docsearch-highlight-color: rgb(19, 205, 227);
