...
.permission-node {
  ...
  &:hover {
    background-color: rgba(31, 137, 175, 0.49);
  }

  &.modified {
    background-color: rgba(0, 34, 252, 0.15);
  ...
  &.new {
    background-color: rgba(11, 138, 241, 0.15);

    &:hover {
      background-color: rgba(33, 54, 158, 0.5);
    }
  }
  ...
  > div:not(.context-ui) {
    ...
    &:hover {
      background-color: rgba(13, 137, 220, 0.11);
    }
  }
...
.context-ui {
  position: absolute;
  background: rgba(0, 217, 255, 0.54);
  padding: 0;
  border-radius: 4px;
  z-index: 11;
  top: 50%;
