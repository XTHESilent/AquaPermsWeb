AquaPerms has a number of online editors / viewers built into the plugin. These do not require self hosting, and public versions everyone can use are deployed in the following locations:
...
The first thing you'll need to do is install and configure a copy of bytebin. This is the system that allows for data to be transferred between the AquaPerms plugin and your web browser (when using the sites).
...
The source for the web apps is available from GitHub: https://github.com/XTHESilent/AquaPermsWeb

You will need to build and host this site on your web server. You can either use the [automatic setup script](https://github.com/AquaPerms/web-installer#automatic-setup) or [install manually](https://github.com/AquaPerms/web-installer#manual-setup).

### Step 3: Configuring the plugin to use your custom bytebin / site

Add the following to the end of the AquaPerms `config.yml`.

```yml
web-editor-url: 'https://example.com/aquaperms/editor/'
verbose-viewer-url: 'https://example.com/aquaperms/verbose/'
tree-viewer-url: 'https://example.com/aquaperms/treeview/'
